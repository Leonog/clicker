        ...
        <View style={styles.bottomMenu}>
          ...
          <View style={styles.bottomMenuRow}>
            <TouchableOpacity
              ...
              onPress={() => {
                this.setState({ showUpgrades: !this.state.showUpgrades })
              }}
            >
              <Text style={styles.upgradesButtonText}>Upgrades {!this.state.showUpgrades ? '⇑' : '⇓'}</Text>
            </TouchableOpacity>
          </View>
          {this.state.showUpgrades &&
            <View style={styles.bottomMenuContent}>
              ...
              <View style={styles.upgradesRow}>
                ...
                >
                  <Text style={{ color: '#FFF', fontWeight: "bold" }}>Comprar ${valUpgrade}</Text>
                </TouchableOpacity>
              </View>
              <View style={styles.upgradesRow}>
                <Text>
                  Dano Idle: {autoDano}/s
                </Text>
                <TouchableOpacity
                  style={{
                ...
                >
                  <Text style={{ color: '#FFF', fontWeight: "bold" }}>Comprar ${valAutoUpgrade}</Text>
                </TouchableOpacity>
              </View>
            </View>
          }
